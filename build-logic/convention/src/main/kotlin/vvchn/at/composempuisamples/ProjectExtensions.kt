...
internal val Project.androidVersionCode: Int
    get() = libs.versions.androidVersionCode.get().toInt()

internal val Project.androidVersionName: String
    get() = libs.versions.androidVersion.get()
